...
export class RelatedUsersService {
  ...
  refIdForLinkStatusChanged: EventEmitter<any> = new EventEmitter();
  refIdForLinkstatus: any;
  ...
  */
  ...
  set refIdLink(refIdLink:any){
    this.refIdForLinkstatus = refIdLink;
    this.isGhostChanged.emit(refIdLink);
  }
  get refIdLink():any{
    return this.refIdForLinkstatus;
  }
  ...
  */
      ...
      private ref_id_for_link!:string;
      ...
      getRefIdForLink(){
        return this.ref_id_for_link;
      }

      setRefIdForLink(ref:string){
        this.ref_id_for_link=ref;
      }
